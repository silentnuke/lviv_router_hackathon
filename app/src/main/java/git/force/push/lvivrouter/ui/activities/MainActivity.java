package git.force.push.lvivrouter.ui.activities;
...
import git.force.push.lvivrouter.ui.fragments.RoutinesPagerFragment;
    ...
    private void selectItem(int position) {
        ...
        switch (navItem){
            case HISTORY:
                ...
                break;
            case  ROUTES_LIST:
                fragment = new RoutinesPagerFragment();
            default:
        ...
        setTitle(NavItems.values()[position].getTitleRes());
